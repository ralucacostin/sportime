            ...
            <div id="navbar">
                ...
                <nav class="navbar navbar-default navbar-transparent navbar-fixed-top" role="navigation">
                    <div class="alert alert-info">
                        <div class="container">
                            Reminder: This is the <b>MVP</b> (Minimum Viable Product) of our reservation system!
                        </div>
                    </div>
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" style="transform: translate(-20%,0)">
                                        <li>
                                            <a href="teams.html">Create A Team</a>
                                        </li>
                                        <li>
